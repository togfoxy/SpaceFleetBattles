...
local function initialsePlanets()
    ...
    PLANETS[1].y = starty
    PLANETS[1].column = 1
    PLANETS[1].tooltip = "+3 pilot / +3 fighter"		--! consider loading resourcing into this table
	PLANETS[1].friendlyfighters = 300
	PLANETS[1].friendlypilots = 3
	PLANETS[1].foefighters = 0
	...
	PLANETS[2].friendlyfighters = 0
	PLANETS[2].friendlypilots = 2
	PLANETS[2].foefighters = 0
	PLANETS[2].foepilots = 0
    PLANETS[3].x = startx + 200
    PLANETS[3].y = starty + 150
	PLANETS[3].column = 2
    PLANETS[3].tooltip = "+2 fighter"
	PLANETS[3].friendlyfighters = 200
	PLANETS[3].friendlypilots = 0
	PLANETS[3].foefighters = 0
	PLANETS[3].foepilots = 0

    PLANETS[4].x = startx + 400
    PLANETS[4].y = starty - 300
	PLANETS[4].column = 3
    PLANETS[4].tooltip = "+1 fighter"
	PLANETS[4].friendlyfighters = 100
	PLANETS[4].friendlypilots = 0
	PLANETS[4].foefighters = 0
	PLANETS[4].foepilots = 0
    PLANETS[5].x = startx + 400
    PLANETS[5].y = starty - 0
	PLANETS[5].column = 3
    PLANETS[5].tooltip = "+1 pilot"
	PLANETS[5].friendlyfighters = 0
	PLANETS[5].friendlypilots = 1
	PLANETS[5].foefighters = 0
	PLANETS[5].foepilots = 0
    PLANETS[6].x = startx + 400
    PLANETS[6].y = starty + 300
	PLANETS[6].column = 3
    PLANETS[6].tooltip = "+1 fighter"
	PLANETS[6].friendlyfighters = 100
	PLANETS[6].friendlypilots = 0
	PLANETS[6].foefighters = 0
	PLANETS[6].foepilots = 0
	...
	PLANETS[9].friendlyfighters = 0
	PLANETS[9].friendlypilots = 0
	PLANETS[9].foefighters = 100
	PLANETS[9].foepilots = 0
    PLANETS[10].x = startx + 800
    PLANETS[10].y = starty - 0
	PLANETS[10].column = 5
    PLANETS[10].tooltip = "-1 pilot"
	PLANETS[10].friendlyfighters = 0
	PLANETS[10].friendlypilots = 0
	PLANETS[10].foefighters = 0
	PLANETS[10].foepilots = 1
	...
	PLANETS[12].friendlyfighters = 0
	PLANETS[12].friendlypilots = 0
	PLANETS[12].foefighters = 0
	PLANETS[12].foepilots = 2
    PLANETS[13].x = startx + 1000
    PLANETS[13].y = starty + 150
	PLANETS[13].column = 6
    PLANETS[13].tooltip = "-2 fighter"
	PLANETS[13].friendlyfighters = 0
	PLANETS[13].friendlypilots = 0
	PLANETS[13].foefighters = 200
	PLANETS[13].foepilots = 0
